...
public class removedoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Enter doctor id to be removed");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/remove_doc.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            code to written for error checking
            
            
            */
            st.executeUpdate("delete from doctor where id="+id+"");
            
             JOptionPane.showMessageDialog(null,"Successful Removed");
             jTextField3.setText("");
             
             
        } catch (SQLException ex) {
             JOptionPane.showMessageDialog(null,"ERROR SOMETHING UNEXPECTED HAPPENED WHILE DELETING");
        }
        }
